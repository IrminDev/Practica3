...
static uint8_t btn_cnt[4u] = {0u, 0u, 0u, 0u};
static uint8_t btn_armed[4u] = {1u, 1u, 1u, 1u};
...
static volatile char rx_buf[48u];
...
void __attribute__((picinterrupt(("")))) isr(void)
{
    ...
    if (PIR1bits.RCIF)
    {
        ...
        else if (!rx_ready && rx_len < 48u - 1u)
        {
            rx_buf[rx_len++] = c;
        }
    }
